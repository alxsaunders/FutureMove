// src/utils/itemImageMapping.ts

// Type for image mapping
type ImageMapping = {
  [key: string]: any;
};

// Map database image paths to require() statements
export const ITEM_IMAGES: ImageMapping = {
  // Profile Rings
...
export const getItemImage = (imagePath: string | null | undefined): any => {
  if (!imagePath) return null;
  return ITEM_IMAGES[imagePath] || null;
};

// Check if image exists
export const hasItemImage = (imagePath: string | null | undefined): boolean => {
